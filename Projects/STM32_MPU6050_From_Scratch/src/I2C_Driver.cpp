...
void I2C_init(void){
    ...
    DMA1_Channel7->CMAR = (uint32_t)&mpu6050_raw_data[0];
    ...
    */
    ...
    I2C1->TRISE = 12; // 300ns/27.7778ns + 1 = 11.79 ~= 12. (300ns is max t_rise for MPU6050. generic from MCU datasheet: 1000us.)
